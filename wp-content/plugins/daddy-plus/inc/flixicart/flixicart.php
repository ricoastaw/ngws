...
require daddy_plus_plugin_dir . 'inc/flixicart/theme-settings/flixita-customizer-options.php';
...
require daddy_plus_plugin_dir . 'inc/flixicart/theme-settings/flixita-default-options.php';
require daddy_plus_plugin_dir . 'inc/flixita/frontpage/daddy-plus-main-header.php';
...
if ( ! function_exists( 'daddy_plus_flixita_frontpage_sections' ) ) :
	function daddy_plus_flixita_frontpage_sections() {
		require daddy_plus_plugin_dir . 'inc/flixicart/frontpage/daddy-plus-index-slider.php';
		require daddy_plus_plugin_dir . 'inc/flixita/frontpage/daddy-plus-index-information.php';
		require daddy_plus_plugin_dir . 'inc/flixita/frontpage/daddy-plus-index-service.php';
		require daddy_plus_plugin_dir . 'inc/flixita/frontpage/daddy-plus-index-call-action.php';
		require daddy_plus_plugin_dir . 'inc/flixicart/frontpage/daddy-plus-index-product.php';
