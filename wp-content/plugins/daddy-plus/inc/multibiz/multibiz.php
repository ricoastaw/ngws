...
if ( ! function_exists( 'daddy_plus_flixita_frontpage_sections' ) ) :
	function daddy_plus_flixita_frontpage_sections() {
		...
		require daddy_plus_plugin_dir . 'inc/multibiz/frontpage/daddy-plus-index-information.php';
		require daddy_plus_plugin_dir . 'inc/arvila/frontpage/daddy-plus-index-service.php';
