						...
						<div class="col-lg-3 col-md-6 col-12">
							<div class="service-inner">
								...
								<div class="service-content">
									...
									<?php endif; ?>
									<div class="fbox-number">0<?php echo esc_html($i+1); ?></div>
									...
									<?php if(!empty($button)): ?>
										<a href="<?php echo esc_url($link); ?>" class="btn btn-primary btn-like-icon"><?php echo esc_html($button); ?><span class="bticn"><i class="fa fa-arrow-right"></i></span></a>
									<?php endif; ?>	
								</div>
							</div>
						</div>
