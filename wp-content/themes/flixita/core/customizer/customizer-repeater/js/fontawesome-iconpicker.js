(function ($) {
    ...
    wp.flixitacustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                flixita_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.flixitacustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.flixitacustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.flixitacustomizerRepeater.iconPickerToggle($(this));
        });
